 ...
 * @author lucky13
 */
public class WithdrawFrame extends javax.swing.JPanel {

    /**
     * Creates new form WithdrawFrame
     */
    public WithdrawFrame(MainApp mn) {
        initComponents();
        this.app = mn;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/Withdraw/header.gif"))); // NOI18N
        jLabel1.setFocusable(false);
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jLabel1.setIconTextGap(0);
        add(jLabel1);
        jLabel1.setBounds(-120, 0, 790, 160);
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        this.app.deduceBalance(Double.parseDouble(amount));
        firstTime = true;
