...
public class LogIn extends javax.swing.JPanel {    
    ...
    private void buttonPress(String text) {
        ...
        if (currentTextField != null) {
            if (text.equals("")) {
                ...
                if ((txt.length() > 6) && (currentTextField == pinTF)){
    ...
    public javax.swing.JPanel getNextFrame() {
        return this.nextFrame;
    }
    
    public void setNextFrame(javax.swing.JPanel nextFrame) {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/LogInForm/Label.gif"))); // NOI18N
        jLabel3.setFocusable(false);
        jLabel3.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        add(jLabel3);
        jLabel3.setBounds(210, 40, 300, 80);

        accNumTF.setEditable(false);
        accNumTF.setBackground(new java.awt.Color(212, 118, 107));
        accNumTF.setFont(new java.awt.Font("JetBrainsMonoNL NF Medium", 1, 24)); // NOI18N
        accNumTF.setForeground(new java.awt.Color(96, 28, 28));
        accNumTF.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED, new java.awt.Color(96, 28, 28), null));
        accNumTF.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        accNumTF.setSelectedTextColor(new java.awt.Color(212, 118, 107));
        accNumTF.setSelectionColor(new java.awt.Color(172, 50, 50));
        accNumTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                accNumTFFocusGained(evt);
            }
        });
        add(accNumTF);
        accNumTF.setBounds(300, 160, 280, 50);

        pinTF.setEditable(false);
        pinTF.setBackground(new java.awt.Color(212, 118, 107));
        pinTF.setFont(new java.awt.Font("JetBrainsMonoNL NF Medium", 1, 24)); // NOI18N
        pinTF.setForeground(new java.awt.Color(96, 28, 28));
        pinTF.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED, new java.awt.Color(96, 28, 28), null));
        pinTF.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        pinTF.setSelectedTextColor(new java.awt.Color(212, 118, 107));
        pinTF.setSelectionColor(new java.awt.Color(172, 50, 50));
        ...
        add(pinTF);
        pinTF.setBounds(300, 240, 280, 50);

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/LogInForm/pin.png"))); // NOI18N
        jLabel2.setFocusable(false);
        jLabel2.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        add(jLabel2);
        jLabel2.setBounds(200, 230, 90, 70);

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/LogInForm/AccNum.png"))); // NOI18N
        jLabel4.setFocusable(false);
        jLabel4.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        add(jLabel4);
        jLabel4.setBounds(120, 150, 170, 70);
    ...
    private void accNumTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_accNumTFFocusGained
        // TODO add your handling code here:
        currentTextField = accNumTF;
        accNumTF.setBorder(this.app.etchedRaised);
        pinTF.setBorder(this.app.defaultBorder);
    }//GEN-LAST:event_accNumTFFocusGained

    private void pinTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_pinTFFocusGained
        // TODO add your handling code here:
        currentTextField = pinTF;
        pinTF.setBorder(this.app.etchedRaised);
        accNumTF.setBorder(this.app.defaultBorder);
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        // TODO add your handling code here:
        String password = String.valueOf(pinTF.getPassword());
        String acc = accNumTF.getText();
        boolean authenticated = this.app.getAccNum().equals(acc) && this.app.getPin().equals(password);
        
        if (authenticated) {
            this.app.switchFrames(this, nextFrame);
            this.app.logIn();
        } else {
            JOptionPane.showMessageDialog(this, "INCORRECT CREDENTIALS", "Try Again", 1);
            pinTF.setText("");
        }
    ...
    private void btnHypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHypeActionPerformed
        // TODO add your handling code here:
        this.buttonPress(btnHype.getName());
